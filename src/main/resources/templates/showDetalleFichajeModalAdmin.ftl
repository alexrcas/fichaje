                ...
                <div class="col">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex mb-2">
                            <h5 class="lh-sm mb-0 me-2 text-body-secondary timeline-item-title <#if fichaje.anulado> text-decoration-line-through </#if>">
                                ${fichaje.tipoFichaje.getName()}

                                <#if fichaje.pendienteAnulacion && !fichaje.anulado>
                                <span class="badge badge-phoenix badge-phoenix-warning">Pdte. Anul.</span>
                                </#if>

                                <#if fichaje.anulado>
                                <span class="ms-1 badge badge-phoenix badge-phoenix-secondary">Anulado</span>
                                </#if>
