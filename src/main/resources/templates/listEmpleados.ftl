    ...
    <div id="tableExample3" data-list='{"valueNames":["fecha","motivo"]}'>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm fs--1 mb-0">
                <thead>
                <tr>
                    <th class="sort border-top" data-sort="inicio">Email / Usuario</th>
                    <th class="sort border-top" data-sort="numeroDias">Nombre</th>
                ...
                <tr>
                    <td class="align-middle motivo ps-1">${empleado.email}</td>
                    <td class="align-middle motivo">${empleado.nombre} ${empleado.apellidos}</td>
